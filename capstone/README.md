...
### Hints
- CREATE ONLY ONE `Scanner` on `System.in`
- Think about Separation of Concerns. In other words, what component has the ultimate 
    responsibility for specific functionality
- Can you limit all user interactions to a single component/class?